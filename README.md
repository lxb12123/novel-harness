...
| **M2** | 合成小册子 + 起草 + **kill-gate** ← 最早的证伪点 | 🚧 **进行中**（修正案 5 / ADR 0011 已冻结；实现、离线验证与真模型运行待完成，见下） |
