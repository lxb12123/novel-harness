...
（逐项状态见 [ARCHITECTURE 的「当前状态」](docs/ARCHITECTURE.md#当前状态)。协议本体之外还有五份修正案，
`EVAL_PROTOCOL_AMENDMENT_{1,2,3,4,5}.md`；1–4 早于 `synth/`，第 5 份晚于 `synth/`，
但五份都早于任何真实推理并另开文件、不覆盖正文。）
