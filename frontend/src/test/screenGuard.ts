...
export const ENGINE_ENUM =
  /\b[A-Z][A-Z0-9]*(?:_[A-Z0-9]+)+\b|\b(?:KNOWS|BELIEVES|UNKNOWN|CANON|PROVISIONAL|PLANNED|REJECTED|RETRACTED|ACTIVE|STALE|FRESH|OWNS|PENDING|RUNNING|SUCCEEDED|FAILED|SUPERSEDED|ACCEPTED|EDITED|AMBIGUOUS|EXACT|FUZZY|NONE|HIDDEN|OPEN|REVOKED|COMPLETE|PARTIAL|MISSING|STATE|LOCATION|DEATH|APPEARED|EVENT|PROFILE|FORESHADOW|CURRENT|UNVERIFIED|SAVED|REFUSED|CANDIDATE_CREATED|CANON_CORRECTION_REQUESTED|PENDING_AUTHOR|PLAN_ONLY|GENERATE_CANDIDATE|APPLY_EXACT_SCOPE|ADJUST_CURRENT_BRIEF|REQUEST_CANON_CORRECTION|REVISE_CHAPTER|REGENERATE_SUMMARY|RERUN_EXTRACTION|MANUAL_REVIEW|AUTHOR_INTENT|AUTHOR_CANON_FACT|AUTHOR_BACKGROUND|EXTRACTED_CURRENT|OBSERVED_TEXT|MACHINE_SUMMARY|MACHINE_INFERENCE|READY_TO_SEAL|NEEDS_AUTHOR|READY_FOR_DRAFT|FOLLOW_OLD|STORY_PROGRESSION|RETCON_NON_SAFETY|ENTER_LOCATION|SEARCH_FOR|TEST_CHARACTER|DEFER_REVEAL|ADVANCE_CLUE|SAFE_FACT|SAFE_LABEL_ONLY)\b|\b(?:Character|Location|Faction|Secret|Foreshadow|Object|StateDim|Chapter)\b/g;
