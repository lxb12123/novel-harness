...
export function ImportReview({
  ...
  return (
    <>
      <p className="onboarding-eyebrow">导入手稿</p>
      <h1 className="onboarding-title">确认这本书</h1>
      <p className="onboarding-lead">我们会在本地为它创建工作台。</p>
      {file && (
      ...
      {reading && <p className="onboarding-lead">正在读取 TXT…</p>}
