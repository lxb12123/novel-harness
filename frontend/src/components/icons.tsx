...
export function DropletIcon() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M12 2.6c-2.4 2.9-3.7 5.6-3.7 7.9a3.7 3.7 0 0 0 7.4 0c0-2.3-1.3-5-3.7-7.9z" />
    </svg>
  );
}
 ...
 *  这版只留主枝根部一对侧枝，形状更清爽。
 *  `strokeWidth` 跟水滴对齐成 1.6（原来 1.3）——线细一档，同样的框里「墨量」
 *  比水滴薄，看着就比水滴小一圈，粗细跟水滴一致视觉重量才对得上。 */
export function SnowflakeIcon() {
  const arm = (
    <>
      <line x1="12" y1="12" x2="12" y2="4.6" />
      <line x1="12" y1="7.6" x2="10.5" y2="6.5" />
      <line x1="12" y1="7.6" x2="13.5" y2="6.5" />
    </>
  );
  return (
    <svg
