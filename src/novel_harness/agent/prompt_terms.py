...
_EN: dict[str, str] = {
    ...
    (
        ...
        "the last few chapters' summaries and the end of the previous chapter "
        "— **don't copy those in**. **It does not see this chapter's current "
        "text** (given it, it copies it), so this is a chapter written from "
        "scratch; to keep some passages verbatim and change the rest, use "
        "revise_passage.\n"
